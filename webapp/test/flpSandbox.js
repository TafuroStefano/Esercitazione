		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Esercitazione",
									"targetURL": "#esercitazione-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esercitazione-display": {
								"semanticObject": "esercitazione",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=esercitazione",
									"url": sap.ui.require.toUrl("esercitazione")
								}
							}
						}
					}
